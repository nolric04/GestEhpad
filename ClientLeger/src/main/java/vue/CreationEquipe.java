...
public class CreationEquipe extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * Récupération de la variable de session, pour obtenir l'établissement et l'id de l'équipe concernés qui sont en attribut
		 */
		...
		out.println("<form name='formulaire' action='ControleGestionEquipe' method='GET'>"
		...
		out.println("	<table width=100%><tr>		"
				+ "			<td width=50% align=center><input type=\"submit\" name=\"bouton\" onClick=submitForm() value=\"Valider\"></td>"
				+ "			<td width=50% align=center><input type=\"submit\" name=\"bouton\" value=\"Retour\"></td>"
				+ "		</tr></table></form>"
		);
